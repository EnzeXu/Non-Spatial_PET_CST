...
def one_time_build_A():
    plans = [
        ...
        ["A3", 4000, "chosen_0", "fixed", 100],
        ["A3", 5000, "chosen_0", "fixed", 100],
        ["A3", 6000, "chosen_0", "fixed", 100],
        ["A4", 1000, "chosen_0", "ranged", 100],
        ["A4", 2000, "chosen_0", "ranged", 100],
        ["A4", 3000, "chosen_0", "ranged", 100],
        ["A4", 4000, "chosen_0", "ranged", 100],
        ["A4", 5000, "chosen_0", "ranged", 100],
        ["A4", 6000, "chosen_0", "ranged", 100],
    ]
    dic = dict()
