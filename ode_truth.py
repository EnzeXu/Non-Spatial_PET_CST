...
def loss_func(params, starts_weight, ct):
    ...
    csf_rate += \
        limit_rate((truth.output[0][0][1200] - truth.output[0][0][300]) / truth.output[0][0][300], thr=ct.increase_rate[0], tol=2.0, p=100.0) + \
        limit_rate((truth.output[1][0][1200] - truth.output[1][0][300]) / truth.output[1][0][300], thr=ct.increase_rate[1], tol=2.0, p=100.0) + \
